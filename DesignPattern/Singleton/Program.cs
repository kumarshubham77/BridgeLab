...
using DesignPattern.Singleton.SingletonLink.SingletonExample;
...
namespace DesignPattern.Singleton
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Value of {0} calcius to farenheit is {1}", celcius, Staticblockinitialization.ToFarenheit(celcius));
            Console.WriteLine("Value of {0} farenheit to celcius is {1}", farenheit, Staticblockinitialization.ToCelcius(farenheit));
            */
            //ThreadSafe
            /*
            Parallel.Invoke(
        ...
        private static void PrintEmployeeDetails()
        {
            ...
            thread.PrintDetails("Sachin Bahubali");
        }

        private static void PrintStudentDetails()
        {
            ThreadSafe thread1 = ThreadSafe.getInstance;
            thread1.PrintDetails("Message 2");
        }
        /*
* {
//Lazy initialization rest
private static void PrintEmployeeDetails()
{
   LazyInitialization lazy = LazyInitialization.getInstance;
   lazy.PrintDetails("message 1 is Forwaded");
   LazyInitialization lazy1 = LazyInitialization.getInstance;
   lazy.PrintDetails("Message 2 is forwaded");
}

private static void PrintStudentDetails()
{
   LazyInitialization lazy = LazyInitialization.getInstance;
   lazy.PrintDetails("Another 1 is Forwaded");
   LazyInitialization lazy1 = LazyInitialization.getInstance;
   lazy.PrintDetails("Another 2 is forwaded");
}
}
*/
