// --------------------------------------------------------------------------------------------------------------------
// <copyright file=HotelOfferVisitor.cs" company="Bridgelabz">
...
{
    /// <summary>
    /// Class HotelOfferVisitor which inherit the OfferVisitor Interface.
    /// </summary>
    /// <seealso cref="DesignPattern.Singleton.BehavioralDesignPattern.VisitorPattern.Offers.OfferVisitor" />
    class HotelOfferVisitor : OfferVisitor
    {
        /// <summary>
        ...
        {
            Console.WriteLine("We are Computing Hotel offer cashback for the bronze Credit card");
        }
        /// <summary>
        /// As Current class is inheriting the OfferVisitor Interface 
        /// thus, it will get all the property defined in that Interface.
        ...
        {
            Console.WriteLine("We are Computing Hotel offer cashback for the Gold Credit card");
        }
