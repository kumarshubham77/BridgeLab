// --------------------------------------------------------------------------------------------------------------------
// <copyright file=BronzeCreditCard.cs" company="Bridgelabz">
...
{
    /// <summary>
    /// BronzeCreditCard is a class whit Inherit the CreditCard interface
    /// </summary>
    ...
    public class BronzeCreditCard : CreditCard
    {
        ...
        /// This class will Inherit the CreditCard Interface.
        /// </summary>
        /// <returns></returns>
