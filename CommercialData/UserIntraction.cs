...
namespace RestOOPs.CommercialData
{
    ...
    {
        /// <summary>
        /// Defining a method UserChoice 
        /// That will take the user input and 
        /// what operations they wanna perform.
        /// </summary>
        public void UserChoice()
        {
            ...
            {
                int UserChoice = 0;
                ///List of operations that user can perform
                ...
                //Taking input from user and store it into UserChoice Variable.
                UserChoice = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("");
                switch (UserChoice)
                {
                    case 1:
                        AccountCreation newly = new AccountCreation();
                        newly.Create();
                        break;
                    case 2:
